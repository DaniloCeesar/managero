      ...
      <ul class="mt-2 space-y-1">
        ...
        <li class="pt-2">
          ...
          <ul id="sidebar-dropdown-folders" class="py-0 space-y-0" v-if="sidebarFavoritesIsOpen">
            ...
            <li>
              <button
                class="flex items-center w-full p-2 text-sm font-medium text-gray-500 rounded-lg hover:bg-gray-100 hover:text-indigo-500 group"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="flex-1 ml-4 text-left whitespace-nowrap">New folder</span>
              </button>
            </li>
          </ul>
        </li>
